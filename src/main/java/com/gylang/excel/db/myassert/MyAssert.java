package com.gylang.excel.db.myassert;
...
public abstract class MyAssert {
    ...
    public static void state(boolean expression, String message) {
        if (!expression) {
            throw new BaseException("myAssert校验异常", message);
        }
    }

    public static void state(boolean expression, Supplier<String> messageSupplier) {
        if (!expression) {
            throw new BaseException("myAssert校验异常", nullSafeGet(messageSupplier));
        }
    }
    ...
    private static void instanceCheckFailed(Class<?> type, @Nullable Object obj, @Nullable String msg) {
        ...
        throw new BaseException("myAssert校验异常", result);
    }
    ...
    public static void fail(String msg) {
        ...
        throw new BaseException("myAssert校验异常", msg);
